...
<div class="col-12">
    ...
    <textarea name="description_fr" class="form-control" id="description_fr" required >  {{ old('description_fr', $service->description_fr ?? '') }}</textarea>
</div>
<div class="col-12">
    <label for="description_en" class="form-label">Description En</label>
    <textarea name="description_en" class="form-control" id="description_en" required >  {{ old('description_en', $service->description_en ?? '') }}</textarea>
</div>
<div class="col-12">
